...
## Usage
  ...
  - Key per le API di OpenAI, ottenibile registrandosi su [OpenAI API Platform](https://openai.com/api/). La key deve essere salvata tra le variabili d'ambiente col nome `OPENAI_API_KEY`.
